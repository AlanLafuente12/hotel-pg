...
class DosificacionRoutes {
    ...
    config() {
        this.router.get('/list/:idhotel', dosificacionController_1.dosificacionController.listarDosificaciones);
        this.router.get('/last/:idhotel', dosificacionController_1.dosificacionController.obtenerUltimaDosificacion);
