...
class HabitacionRoutes {
    ...
    config() {
        this.router.get('/list/:id', habitacionController_1.habitacionController.listarHabitaciones);
        this.router.get('/list/libres/:id', habitacionController_1.habitacionController.listarHabitacionesLibres);
