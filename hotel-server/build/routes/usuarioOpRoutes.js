...
class UsuarioOpRoutes {
    ...
    config() {
        this.router.get('/dehotel/:id', usuarioOpController_1.usuarioOpController.listarUsuarioOpDeHotel);
        this.router.get('/gerentes', usuarioOpController_1.usuarioOpController.listarUsuarioOpGerente);
