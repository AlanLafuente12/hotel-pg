...
class ProductoRoutes {
    ...
    config() {
        this.router.get('/list/:id', productoController_1.productoController.listarProductos);
        this.router.get('/list/disponibles/:id', productoController_1.productoController.listarProductosDisponibles);
