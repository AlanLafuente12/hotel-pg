...
declare namespace e {
    ...
    interface Request<P = core.ParamsDictionary, ResBody = any, ReqBody = any, ReqQuery = core.Query> extends core.Request<P, ResBody, ReqBody, ReqQuery> { usuario?: any; }
    ...
    export interface Response<ResBody = any> extends core.Response<ResBody> { usuario?: any; }
