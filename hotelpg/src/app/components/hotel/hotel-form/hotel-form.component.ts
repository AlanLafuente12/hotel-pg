...
export class HotelFormComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (params.id){
      this.hotelservice.getHotel(params.id)
        .subscribe(
          (res: any) => {
            this.hotel = res;
    ...
    if (this.editando){
      ...
      this.titulo = 'Agregar Hotel';
      console.log('agregar');
      this.imagePath = this.imageService.getImagePath() + 'null';
    }
  }
      ...
      .subscribe(
        (res: any) => {
          ...
          if (this.selectedFile){
            ...
            this.subirArchivoService.subirImagen(this.selectedFile.file, res.insertId).subscribe(
              (res2) => {
  ...
  cargarDatos(): void{
    ...
    /* CAMBIO DE MANEJO DE IMAGENES DE HOTELES
    if (this.selectedFile){
      this.hotel.logo = `hotel-${this.hotel.id_hotel}.png`;
